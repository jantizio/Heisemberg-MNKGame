...
public class NostroPlayer implements MNKPlayer {
	...
	/**
	 * Find out how many sequence are there in the board(it scans forwards), cost: O(4MNK) ~ O(MNK).
	...
	/**
	 * Find out how many sequence are there in the board(it scans backwards), cost: O(4MNK) ~ O(MNK).
	 * @param board board to check.
	 * @param sequence looking for sequence.
	 * @return number os sequence.
	 */
